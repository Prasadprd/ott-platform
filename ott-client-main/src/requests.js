...
export const GITHUB_AVATAR_URL = "https://picsum.photos/200/300";
const GITHUB_ASSETS_BASE_URL = "https://cdn.jsdelivr.net/";
...
const { VITE_REACT_APP_API_KEY: REACT_APP_API_KEY } = import.meta.env;
