...
export const fetchMovieDataConfig = [
  ...
  {
    id: 10,
    thunk: fetchFakeflixMoviesAsync,
    url: "http://localhost:8000/v1/content",
    title: "FakeFlix movies",
    genre: "general",
    selector: movieSelectors.selectFakeflixMovies,
  },
  {
    id: 1,
