...
export const selectFakeflixMovies = (state) => state.movies.fakeflixMovies;
...
export const selectFakeflixSelector = createSelector(
  [selectFakeflixMovies],
  (fakeflixMovies) => fakeflixMovies.data
);
